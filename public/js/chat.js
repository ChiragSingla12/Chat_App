...
async function showGrp() {
    try {
        ...
        console.log('groups info=> ', groupData);
    ...
    try {
        ...
        groupData.forEach(group => {
            ...
            div.innerHTML += `<div class='list-group-item' id='${group.name}'>
                                <div class='d-flex'>
                                    <span class='text-size ms-3 me-4'>
        ...
        console.log('res is -- ', result , 'result.data.member', result.data.member);
